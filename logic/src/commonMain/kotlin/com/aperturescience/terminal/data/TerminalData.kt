...
import com.aperturescience.terminal.data.TerminalData.loginFlowScreens
...
object TerminalData {
     ...
     * screen index (0..11).
     */
    val loginFlowScreens: List<String> =
        listOf(
            "> ",
            "Username> ",
            "Password> ",
            "ERROR 07 [Incorrect Password]^^Password> ",
            ...
            "Congratulations!^^You have finished the:^^ENRICHMENT CENTER TEST SUBJECT APPLICATION^FORMS-EN-2873-FORM (PART1: PERSONALITY & GENERAL KNOWLEDGE)^^Please enter your 64 digit UIN(+L) to complete the process.^^> ",
            "The entered UIN(+L) does not match your assigned UIN(+L).^^Please REMAIN AT YOUR WORKSTATION until a Computer-Aided-Enrichment Crisis Team arrives.^^",
     ...
     */
    val loginFlowScreenDelays: List<Int> =
        listOf(
            75,
            75,
            75,
     ...
     */
    val notesHistoryPages: List<String> =
        listOf(
        ...
        listOf(
            ...
            Question(
                ...
                listOf(
                    ...
                    "have not previously performed an enrichment center program",
                ),
            ),
            Question(
                3,
            ...
            Question(
                ...
                listOf(
                    "Long Sleeves",
                    "Short Sleeves",
                    "Sleeveless / Shirtless / No Preference",
                ),
            ),
            Question(
                11,
            ...
            Question(
                16,
                "Are you plagued by suspicions that other people, including coworkers and relatives, may be doing things behind your back that will hurt you?",
                QuestionType.RADIO,
                listOf(
                    "Yes",
                    "No",
            ...
            Question(
                21,
                "Other than a large egret, what wild animal would you like to domesticate? NOTE: Several choices, including, but not limited to, 'Large Egret', may trigger an investigation. Your supervisor has no further information about instigating animals or the investigatory process, though, upon request, your supervisor can provide further details about his or her authorized prophylactic unfamiliarity with procedure.",
                QuestionType.RADIO,
                listOf(
                    "Aardvark",
                    "Aardwolf",
                    ...
                    "European goldfinch",
                    "European hedgehog",
                    "European large crane fly",
                    "European lynx",
                    "European May cockchafer",
                    "European polecat",
                    "European rabbit",
                    "European red kite",
                    "European robin",
                    ...
                    "Korean doty barbel",
                    "Korean dusky cicada",
                    "Korean flat bitterling",
                    "Korean freshwater snail",
                    "Korean ghost crab",
                    "Korean grass cicada",
                    "Korean gray wolf",
                    "Korean harvestman cicada",
                    "Korean horse cicada",
                    "Korean Ladislavia",
                    "Korean land slug",
                    "Korean magpie viper",
            ...
            Question(
                ...
                QuestionType.CHECKBOX,
                listOf("I have read all or most of the above."),
            ),
            Question(
                28,
            ...
            Question(
                31,
                "What is your favorite number between 31 and 37?",
                QuestionType.RADIO,
                listOf("31", "32", "33", "34", "35", "36", "37"),
            ),
            Question(
                32,
            ...
            Question(
                33,
                "In case you forget your UIN(+L) and need to retrieve it later, please list a crime that only you would know that you have committed:",
                QuestionType.TEXT,
                listOf(),
            ),
            Question(
            ...
            Question(
                36,
                "Would you like to use a prism to study light?",
                QuestionType.RADIO,
                listOf("Yes", "No"),
            ),
            Question(
            ...
            Question(
                40,
                "Complete the following statement with the answer that DOES NOT apply to you:^I am often:",
                QuestionType.RADIO,
                listOf(
                    "worried that life is vague and unreal",
                    "suspicious of the actions of others",
                    "prejudiced in favor of my own department, lab, product, skin color, etc.",
                    ...
                    "too depressed to kill an animal or colleague in order to put it out of its pain",
                    "convinced of the correctness of my opinions on subjects about which I am not an expert",
