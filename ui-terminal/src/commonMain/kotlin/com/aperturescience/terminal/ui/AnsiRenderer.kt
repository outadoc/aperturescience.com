 ...
 * [EngineState.displayText], then places the real cursor at the end of the text - unlike Mosaic's
 * `AnsiRendering`, which always leaves it stranded on a stray line below all content.
 */
