...
fun App() {
    ...
    Text(
        ...
        modifier = Modifier.onKeyEvent { event ->
            ...
            // commands that also exit) - so it's handled here rather than in TerminalEngine.
            // Always exits, regardless of engine state, even from the cake/bosskey loop which has
            // no in-story escape in the original.
